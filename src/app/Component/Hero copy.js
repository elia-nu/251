            ...
            <div className="w-full md:w-1/2 space-y-12">
              ...
              >
                <h1 className="text-6xl md:text-7xl lg:text-8xl font-black leading-tight">
                  ...
                  <br />
                  <span
                    className="text-white relative inline-block after:content-[''] after:absolute after:-bottom-2 
              ...
              >
                <p className="transform hover:translate-x-4 transition-all duration-500 hover:text-white">
                  We are a full-service communications and public relations firm
                  with offices in
                ...
                <p className="transform hover:translate-x-4 transition-all duration-500 hover:text-white">
                  ...
                  , delivering comprehensive solutions for both local and
                  international clients.
                </p>

                <p className="transform hover:translate-x-4 transition-all duration-500 hover:text-white">
                  From ATL to BTL marketing strategies, we create end-to-end
                  solutions that amplify our clients market presence through our
                  extensive network of leading service and media partnerships.
                </p>
              </motion.div>
          ...
          >
            {VISION_SLIDES.map((slide, index) => (
              <div key={index} className="px-4 py-4">
                <div
                  className="bg-gradient-to-br from-gray-800/0 to-gray-900/0 rounded-2xl overflow-hidden shadow-2xl 
